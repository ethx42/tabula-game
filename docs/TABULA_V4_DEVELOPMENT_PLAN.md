...
export function ReactionBar({ onReact, cooldownMs = 1000 }: ReactionBarProps) {
  ...
  const [cooldownEmoji, setCooldownEmoji] = useState<ReactionEmoji | null>(null);
...
```json
{
  ...
  "game.controls": ["pause", "resume", "reset", "history", "fullscreen", "exitFullscreen", "endSession", "muteSound", "enableSound", "soundOn", "soundOff"],
  "pairing": ["title", "scanQr", "orEnterCode", "roomCode", "playStandalone", "spectatorLink"],
